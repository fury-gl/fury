...
def test_ui_progress():
    progressui = ui.ProgressUI(
        size=(500, 300), initial_value=-1, min_value=-5, max_value=5, padding=10
    )

    show_manager = window.ShowManager(size=(800, 800), title="Progress UI Example")
