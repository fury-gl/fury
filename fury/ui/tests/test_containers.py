...
def test_ui_tab_ui(interactive=False):
    ...
    npt.assert_equal(tab_ui_top.tabs[0].title_bold, False)
    npt.assert_equal(tab_ui_top.tabs[1].title_bold, False)
    npt.assert_equal(tab_ui_top.tabs[2].title_bold, False)

    tab_ui_top.tabs[0].title_bold = True
    tab_ui_top.tabs[1].title_bold = False
    tab_ui_top.tabs[2].title_bold = True

    npt.assert_equal(tab_ui_top.tabs[0].title_bold, True)
    npt.assert_equal(tab_ui_top.tabs[1].title_bold, False)
    npt.assert_equal(tab_ui_top.tabs[2].title_bold, True)

    npt.assert_equal(tab_ui_top.tabs[0].title_color, (.0, .0, .0))
    npt.assert_equal(tab_ui_top.tabs[1].title_color, (.0, .0, .0))
    npt.assert_equal(tab_ui_top.tabs[2].title_color, (.0, .0, .0))

    tab_ui_top.tabs[0].title_color = (1, 0, 0)
    tab_ui_top.tabs[1].title_color = (0, 1, 0)
    tab_ui_top.tabs[2].title_color = (0, 0, 1)

    npt.assert_equal(tab_ui_top.tabs[0].title_color, (1., .0, .0))
    npt.assert_equal(tab_ui_top.tabs[1].title_color, (.0, 1., .0))
    npt.assert_equal(tab_ui_top.tabs[2].title_color, (.0, .0, 1.))

    npt.assert_equal(tab_ui_top.tabs[0].title_font_size, 18)
    npt.assert_equal(tab_ui_top.tabs[1].title_font_size, 18)
    npt.assert_equal(tab_ui_top.tabs[2].title_font_size, 18)

    tab_ui_top.tabs[0].title_font_size = 10
    tab_ui_top.tabs[1].title_font_size = 20
    tab_ui_top.tabs[2].title_font_size = 30

    npt.assert_equal(tab_ui_top.tabs[0].title_font_size, 10)
    npt.assert_equal(tab_ui_top.tabs[1].title_font_size, 20)
    npt.assert_equal(tab_ui_top.tabs[2].title_font_size, 30)

    npt.assert_equal(tab_ui_top.tabs[0].title_italic, False)
    npt.assert_equal(tab_ui_top.tabs[1].title_italic, False)
    npt.assert_equal(tab_ui_top.tabs[2].title_italic, False)

    tab_ui_top.tabs[0].title_italic = False
    tab_ui_top.tabs[1].title_italic = True
    tab_ui_top.tabs[2].title_italic = False

    npt.assert_equal(tab_ui_top.tabs[0].title_italic, False)
    npt.assert_equal(tab_ui_top.tabs[1].title_italic, True)
    npt.assert_equal(tab_ui_top.tabs[2].title_italic, False)
    ...
    tab_ui_bottom.tabs[0].title_color = (1, 0, 0)
    tab_ui_bottom.tabs[1].title_color = (0, 1, 0)
    tab_ui_bottom.tabs[2].title_color = (0, 0, 1)

    tab_ui_bottom.tabs[0].title_font_size = 10
    tab_ui_bottom.tabs[1].title_font_size = 20
