...
def test__peaks_colors_from_points():
    ...
    peaks_colors_object = PeakActor._peaks_colors_from_points(
        points, colors=None)
    vtk_colors, colors_are_scalars, global_opacity = peaks_colors_object
...
def test__points_to_vtk_cells():
    ...
    vtk_cells = PeakActor._points_to_vtk_cells(points)
