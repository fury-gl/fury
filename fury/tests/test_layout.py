...
def get_default_panels(sizes=[(100, 100), (200, 200)],
...
def test_layout_apply():
    ...
    npt.assert_array_equal([panel_first.position, panel_second.position],
                           [(0, 0), ]*2)
...
def test_grid_layout_get_cell_shape():
    ...
    panel_shape_sqaure = grid_square.get_cells_shape([panel_first,
                                                      panel_second])

    panel_shape_diagonal = grid_diagonal.get_cells_shape([panel_first,
                                                          panel_second])
    ...
    npt.assert_array_equal(panel_shape, [(200, 200), ]*2)
    npt.assert_array_equal(panel_shape_sqaure, [(200, 200), ]*2)
    npt.assert_array_almost_equal(panel_shape_diagonal,
                                  [(282.8, 282.8), ]*2, 0)
...
def test_grid_layout_compute_positions():
    ...
    panel_position_square = grid_square.compute_positions([panel_first,
                                                           panel_second])

    panel_position_diagonal = grid_diagonal.compute_positions([panel_first,
                                                               panel_second])
