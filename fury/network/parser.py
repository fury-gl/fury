...
def parse_network(data, format):
    """Parse string data into a Network object.
    ...
    -------
    Network
        The populated graph dataset representation.
    """
...
def stringify_network(network, format):
    """Convert a Network object into a string of the specified format.

    Parameters
    ----------
    network : Network
        The target dataset source object tracking details.
    format : str
