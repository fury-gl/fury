...
The FURY project is happy to announce the release of FURY 2.0.0a7!
...
.. include:: ../../release_notes/releasev2.0.0a7.rst
    :start-after: --------------
    :end-before: Details

.. note:: The complete release notes are available :ref:`here <releasev2.0.0a7>`
