...
An interactive explorer for three-dimensional fractals using FURY:
- Sierpinski Tetrahedron (Tetrix)
- Menger Sponge
- Moseley Snowflake

Controls:
Press [1] to view Sierpinski Tetrix
Press [2] to view Menger Sponge
Press [3] to view Moseley Snowflake
"""

###############################################################################
# Import the required libraries and event types.
import numpy as np
...
###############################################################################
# Initialize state dictionary and pre-generate all the fractals.
state = {
    "counter": 0,
    "active_index": 0,
}
