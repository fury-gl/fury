...
# print(len(bond_colors), len(bond_coords))
...
scene.add(actor.streamtube(bond_coords, colors=bond_colors, linewidth=0.05))
scene.add(actor.sphere(atom_coords, colors=colors_atoms, radii=radii, phi=32, theta=32))
#scene.add()
