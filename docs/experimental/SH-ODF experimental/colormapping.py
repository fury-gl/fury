"""
This spript includes COLORMAP experimentation for ODF glyphs
"""
import numpy as np
import os
...
if __name__ == '__main__':
    ...
    colormap = create_colormap(np.arange(0.0, 1.0, 1 / 256), "plasma")
    ...
    box_sd_stg_actor.GetProperty().SetTexture("colormap", texture)
    # =========================================================================
    ...
    sdf_frag_impl = \
        ...
        if(t.y > -0.5 )
        {
            ...
            // ================================================================
            //vec2 tex_coords = gl_FragCoord.xy/t.xy;
            vec4 text = texture(colormap, t.xy);
            fragOutput0 = vec4( text.rgb, 1.0);
            // ================================================================
