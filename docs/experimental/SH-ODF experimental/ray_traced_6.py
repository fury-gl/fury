"""
Fury's improved version of the script ray_traced_2.py.
 - Improved scalability using scale from python properties.
"""
...
if __name__ == "__main__":
    ...
    centers = np.array([[-1, 1, 0], [0, 0, 0], [2, -2, 0]])
    ...
    //vec2 uv = frag_coord / vec2(1. / scaleVSOutput);
    //vec2 uv = frag_coord;
