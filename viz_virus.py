...
sphereMapper.SetVertexShaderCode("""
//VTK::System::Dec
...
void main () {
  ...
  vec4 noisePos = vertexMC;
  float i = (noise(noisePos) + 1.0) * 0.5;
  vec4 tmpPos = MCDCMatrix*(vertexMC + vec4(normalMC,1.0)*i);
